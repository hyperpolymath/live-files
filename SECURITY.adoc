...
[arabic]
. Navigate to
https://github.com/hyperpolymath/live-files/security/advisories/new[Report
a Vulnerability]
...
https://github.com/hyperpolymath/live-files/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/live-files/discussions[GitHub
Discussions]
...
_Thank you for helping keep live-files and its users safe._ 🛡️
