...
doctor:
    @echo "Running diagnostics for live-files..."
...
heal:
    @echo "Attempting auto-repair for live-files..."
...
help-me:
    @echo "=== live-files Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/live-files/issues/new"
    @echo ""
