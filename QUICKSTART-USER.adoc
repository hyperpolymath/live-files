...
// Replace live-files, Live Files — See README.adoc for details., just run, Live Files started successfully. with actuals
= live-files — Quick Start for Users
:toc:
:toclevels: 2

== What is live-files?

Live Files — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./live-files-portable
----
...
[source]
----
Live Files started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/live-files/wiki
