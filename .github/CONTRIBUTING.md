...
# Contributing — live-files

## Audience

Developers working **on** `live-files`. For consumers (people calling or
...
``` bash
git clone git@github.com:hyperpolymath/live-files.git
cd live-files
...
- Bugs in `live-files`: file at `hyperpolymath/live-files/issues`.
