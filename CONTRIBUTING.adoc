...
git clone https://github.com/hyperpolymath/live-files.git cd live-files
...
toolbox create live-files-dev toolbox enter live-files-dev # Install
...
live-files/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
