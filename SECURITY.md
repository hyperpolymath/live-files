...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/live-files/security/advisories/new)
...
- This repository (`hyperpolymath/live-files`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/live-files/security/advisories)
...
When using live-files, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/live-files/security/advisories)
- [Security Advisories](https://github.com/hyperpolymath/live-files/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/live-files/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/live-files/discussions) |
...
*Thank you for helping keep live-files and its users safe.* 🛡️
